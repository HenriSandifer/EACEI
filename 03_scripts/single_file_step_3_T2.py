...
def step2_rename_and_add_indicators(df, file_path, header_map):
    ...
    print(f"  - columns to drop at end of step 2 are : {cols_to_drop}")
...
if __name__ == '__main__':
    ...
    example_file = r'C:\Users\Henri\Documents\Data Science\Portfolio\SQL\Datasets\EACEI\01_data_raw\2021\irecoeacei21_xlsx\of_interest\step_2\2021_NAF_T2.csv'
